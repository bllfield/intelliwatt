        ...
        <section className="bg-brand-white rounded-lg p-6 mb-8 shadow-lg">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <a
              ...
              className="block p-4 border-2 border-brand-blue/20 rounded-lg hover:border-brand-blue hover:bg-brand-blue/5 transition-colors"
            >
              <div className="font-semibold text-brand-navy mb-1">🧾 Manual Monthly Lab</div>
              <div className="text-sm text-brand-navy/60">
                Browser-based test harness for the real customer manual-monthly flow, with diagnostics
              </div>
            </a>
            <a
              ...
              className="block p-4 border-2 border-brand-blue/20 rounded-lg hover:border-brand-blue hover:bg-brand-blue/5 transition-colors"
            >
              <div className="font-semibold text-brand-navy mb-1">Compare Day Policy</div>
              <div className="text-sm text-brand-navy/60">
                Shared validation-day selection for Past Sim compare intervals — global owner for Manual GapFill and One Path
              </div>
            </a>
            <a
            ...
            <a
              ...
              className="block p-4 border-2 border-brand-blue/20 rounded-lg hover:border-brand-blue hover:bg-brand-blue/5 transition-colors"
            >
              <div className="font-semibold text-brand-navy mb-1">Model Intelligence Lab</div>
              <div className="text-sm text-brand-navy/60">
            ...
            <a
              href="/admin/tools/surface-parity"
              className="block p-4 border-2 border-brand-blue/20 rounded-lg hover:border-brand-blue hover:bg-brand-blue/5 transition-colors"
            >
              <div className="font-semibold text-brand-navy mb-1">Surface parity lab</div>
              <div className="text-sm text-brand-navy/60">
                Enter any email to prove user Usage/baseline and One Path share the same contracts per data mode
              </div>
            </a>
            <a
