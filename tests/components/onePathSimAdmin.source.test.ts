...
describe("One Path Sim Admin harness wiring", () => {
  ...
  it("keeps the harness thin and reuses shared editors", () => {
    ...
    expect(source).toContain("/api/admin/tools/validation-day-policy");
    expect(source).toContain("Actual context house");
    expect(source).toContain("validationDayPolicySnapshot");
    ...
    expect(source).toContain("validationDayPolicySnapshot?.activePolicy?.selectionMode");
    expect(source).toContain("validationInfoOpen");
    expect(source).toContain("VALIDATION_SELECTION_MODE_DETAILS");
    expect(source).toContain("Active global policy");
    expect(source).toContain("Compare-day selection is owned");
    ...
    expect(source).toContain("resolveDefaultPastPresetKeyForLookupSourceContext");
    ...
    expect(source).toContain('displayRunType === "BASELINE_PASSTHROUGH"');
    ...
    expect(source).toContain("displayRunType === \"PAST_SIM\"");
    expect(source).toContain("runType={displayRunType}");
  ...
  it("keeps Green Button Past Sim on the inline One Path run path", () => {
    ...
    expect(routeSource).toContain("adminRunTrace");
    expect(routeSource).toContain("onePathAdminMaskedRunDiagnostics");
