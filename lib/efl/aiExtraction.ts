...
export function buildPlanRulesExtractionPrompt(
  ...
  return [
    ...
    '  with isFree = true and rateCentsPerKwh = 0, and set planRules.rateType = \"TIME_OF_USE\".',
    ...
    "  as-is even though the engine may require manual review.",
    "- For billCredits, always set a descriptive label and distinguish between",
    '  USAGE_THRESHOLD credits (thresholdKwh > 0) and BEHAVIOR credits (e.g. "AutoPay + Paperless").',
