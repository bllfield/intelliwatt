...
type BaseloadFromCurveOptions = BaseloadOptions & {
  homeTimezone: string;
  /** Home-local dates with simulated fill (travel/vacant/incomplete/etc.) — omitted from baseload like Usage actual intervals. */
  simulatedHomeDateKeys?: Set<string>;
};

/** Same baseload owner as Usage (`lib/usage/computeHomeBaseloadKw`). */
