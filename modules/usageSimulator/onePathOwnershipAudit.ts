  ...
  return {
    ...
    pageSurfaceAuditMatrix: [
      ...
      },
      {
        ...
        ownerSymbols: ["POST"],
        notes:
          "Shows lookup-time context including actual dataset summary/meta, saved manual payload, travel ranges, profiles, and shared weather preview.",
      },
      {
        ...
        pageOnly: false,
        backedBySharedOwner: true,
        ownerFiles: ["modules/usageSimulator/simulationVariablePolicy.ts", "app/api/admin/tools/one-path-sim/variables/route.ts"],
      ...
      },
      {
        ...
        pageOnly: false,
        backedBySharedOwner: true,
        ownerFiles: ["modules/usageSimulator/simulationVariablePresentation.ts", "components/admin/OnePathSimAdmin.tsx"],
      ...
      },
      {
        ...
        pageOnly: false,
        backedBySharedOwner: true,
        ownerFiles: ["modules/usageSimulator/onePathSim.ts"],
      ...
      },
      {
        ...
        pageOnly: false,
        backedBySharedOwner: true,
        ownerFiles: ["modules/usageSimulator/simulationVariablePolicy.ts", "modules/usageSimulator/onePathSim.ts"],
      ...
      },
      {
        ...
        pageOnly: false,
        backedBySharedOwner: true,
        ownerFiles: ["modules/usageSimulator/onePathTruthSummary.ts"],
    ...
    aiCopyPayloadInventory: [
      ...
      },
      {
        ...
        requiresRun: false,
        sourcedFromSharedShaper: true,
        ownerFiles: ["modules/usageSimulator/onePathOwnershipAudit.ts", "modules/usageSimulator/simulationVariablePresentation.ts"],
    ...
    sharedWiringFlow: [
      ...
      },
      {
        ...
        ownerFile: "modules/usageSimulator/onePathSim.ts",
      ...
      },
      {
        ...
        ownerFile: "modules/usageSimulator/simulationVariablePresentation.ts",
    ...
    externalSurfaceClassification: [
      ...
      },
      {
        ...
        classification: "shared_run_orchestrator",
        ownerFiles: ["app/api/admin/tools/one-path-sim/route.ts", "modules/usageSimulator/onePathSim.ts"],
    ...
    driftRiskWatchlist: [
      ...
      },
      {
        ...
        currentState: "tightened_in_this_pass",
        ownerFiles: ["app/api/admin/tools/one-path-sim/route.ts", "modules/usageSimulator/simulationVariablePolicy.ts"],
      ...
      },
      {
        ...
        ownerFiles: ["components/admin/OnePathSimAdmin.tsx", "modules/usageSimulator/simulationVariablePresentation.ts"],
