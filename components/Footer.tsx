          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-brand-blue/80">
                ...
                <li><button onClick={handleAdminClick} className="hover:text-brand-white transition-colors text-sm text-brand-blue/80 text-left bg-transparent border-none p-0 m-0 font-inherit">Admin Access</button></li>
              </ul>
            </div>
          </div>
