        ...
        >
          ...
          <div className="space-y-2 rounded-2xl border border-brand-blue/30 bg-brand-blue/5 p-4 text-sm text-brand-navy">
            <div className="font-semibold uppercase tracking-wide text-brand-navy/80">
              TDSP delivery billing (auto-detected)
            </div>
            <p className="text-xs text-brand-navy/70">
              This is detected from your uploaded EFL/bill. IntelliWatt will treat TDSP delivery as{" "}
              <span className="font-semibold">
                {deliveryIncluded ? "included in the REP energy rate" : "billed separately"}
              </span>
              .
            </p>
          </div>
