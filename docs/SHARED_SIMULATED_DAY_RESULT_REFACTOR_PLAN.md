...
- **Persisted actual intervals** after ingest (`docs/USAGE_INTERVAL_SOURCE_OF_TRUTH.md`, PC-2026-08) are upstream truth for historical days; raw vendor bytes are not live sim input.
