...
- **SMT interval coverage (shipped PC-2026-05):** **`docs/SMT_UNIFICATION_COMPLETE.md`** + **`docs/PROJECT_PLAN.md` → PC-2026-05**. Permanent enforcement: `.cursor/rules/smt-unification-lock.mdc`. Green Button out of scope for SMT fixes; SMT strict 96/96; single heal `lib/usage/ensureSmtCoverage.ts`; window `lib/usage/canonicalMetadataWindow.ts`.
