...
- **SMT unification (in progress):** **`docs/PROJECT_PLAN.md` → PC-2026-05** (master plan entry). Detail: `docs/SMT_UNIFICATION_PLAN.md`, prompts: `docs/SMT_UNIFICATION_PHASE_PROMPTS.md`, new chat: `docs/SMT_UNIFICATION_AGENT_BOOTSTRAP.md`. Green Button out of scope; SMT strict 96/96; single heal owner `lib/usage/ensureSmtCoverage.ts` when shipped.
