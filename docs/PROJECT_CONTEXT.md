...
- **Manual GapFill closeout (MG-1–MG-6 shipped):** authoritative admin pipeline doc `docs/MANUAL_GAPFILL_CLOSEOUT.md`. Commits `814e0839`–`ae380115`. Admin UI `/admin/tools/manual-gapfill` wires MG-1–MG-5 client-side only; legacy GapFill + `EXACT_INTERVALS` unchanged; no production scoring/WAPE/Simulation Accuracy changes.
